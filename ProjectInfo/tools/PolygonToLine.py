'''-------------------------------------------------------------------------------
 Tool Name:   PolygonToLine
 Source Name: PolygonToLine.py
 Version:     ArcGIS 10.1
 License:     Apache 2.0
 Author:      Yoav Abadi
...
class PolygonToLine(object):
    def __init__(self):
        ...
        self.description = "Create a PolyLine layer from a Polygon layer."
    ...
    def execute(self, parameters, messages):
        ...
        result_geometry = [polygon.boundary() for polygon in geometries_list]
